...
namespace BassVisAPI
{
    ...
    public sealed class BassVis
    {
        ...
        [DllImport("bass_vis.dll", EntryPoint="BASSVIS_GetModulePresetNameList", CharSet=CharSet.Auto)]
        private static extern IntPtr BASSVIS_GetModulePresetNameListPtr(
            BASSVIS_PARAM param, 
            [In, MarshalAs(UnmanagedType.LPStr)] string pluginPath);

        [DllImport("bass_vis.dll", EntryPoint="BASSVIS_GetModulePresetName", CharSet=CharSet.Auto)]
        ...
        [DllImport("bass_vis.dll", EntryPoint="BASSVIS_GetPluginName", CharSet=CharSet.Auto)]
        ...
        [DllImport("bass_vis.dll", EntryPoint="BASSVIS_WINAMP_RemoveCallback", CharSet=CharSet.Auto)]
        public static extern void BASSVIS_WINAMPRemoveCallback();

        [DllImport("bass_vis.dll", EntryPoint="BASSVIS_WINAMP_SetStateCallback", CharSet=CharSet.Auto)]
